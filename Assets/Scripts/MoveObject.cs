...
public class MoveObject : MonoBehaviour
{
    ...
    [Header("速さ")] public float moveObject_speed;
        ...
        if (movePoint != null && movePoint.Length > 1 && rb != null)
        {
            ...
            if (!returnPoint)
            {
                ...
                if (Vector2.Distance(transform.position, movePoint[nextPoint].transform.position) > 0.1f)
                {
                    ...
                    Vector2 toVector = Vector2.MoveTowards(transform.position, movePoint[nextPoint].transform.position, moveObject_speed * Time.deltaTime);
